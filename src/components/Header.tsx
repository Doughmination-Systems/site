...
const ThemeToggle = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 bg-muted rounded-full p-1">
      ...
      >
        <span 
          className={`absolute top-0.5 w-4 h-4 bg-foreground rounded-full transition-all duration-200 ${
      ...
      <div className="flex items-center justify-between h-full px-4 md:px-6">
        <div className="flex items-center gap-4">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            />
            <span className="font-bold text-lg hidden sm:inline">Doughmination Modding</span>
          </Link>
        </div>
        ...
        <div className="flex-1 max-w-md mx-4 hidden md:block">
          <div className="relative">
            ...
            />
            <kbd className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none hidden sm:inline-flex h-5 select-none items-center gap-1 rounded border border-border bg-background px-1.5 font-mono text-xs text-muted-foreground">
              ⌘K
            </kbd>
          </div>
        </div>
